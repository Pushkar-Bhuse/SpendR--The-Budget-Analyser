    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liability', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET, to='analysis.Liability')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('percentage', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET, to='analysis.Group')),
                ('liability', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET, to='analysis.Liability')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now=True)),
                ('spent_on', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET, to='analysis.Liability')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
